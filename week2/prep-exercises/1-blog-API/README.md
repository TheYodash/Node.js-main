...
| Read one  | Given a title, return the content of a single blog post | GET    |/blogs/{Name}|
| Update    | Given a title and content update an existing blog post  | PUT    |/blogs/{Name}|
| Delete    | Given a title delete an existing blog post              | DELETE |/blogs/{Name}|
